...
<center>![](figs/density_approach.png){width=95%}<p><small>Fig. 10 Trip-based approach (left)<footnote>Lee et al., 2019</footnote> vs. density-based approach (right).<footnote>Paper II</footnote></small></p></center>
</div>
...
<div>
<center>![](figs/modal_competition_framework.png){width=95%}<p><small>Fig. 16 Data enrichment for ride-sourcing trip data.<footnote>Paper V</footnote></p></small></center>
</div>
