...
<p><small>**Input**- sparse mobility traces that can not be directly converted to trips.</small></p>
<center>![](figs/input_output_input.png){width=30%}</center>
</div>

<div style="float: right; width: 49%;">
<p><small>**Output**- synthesised mobility converted to daily trips.</small></p>
<center>![](figs/input_output_output.png){width=30%}</center>
</div>
